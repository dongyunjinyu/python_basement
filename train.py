"""
    $ python train.py --data dataset/dataset.yaml --weights yolov5s.pt --img 640 --epochs 3 \
    $ python train.py --data dataset/dataset.yaml --weights None --cfg ./yolov5s.yaml --img 640 --epochs 100 --patience 30 --batch-size 8
"""
...
def train(hyp, opt, device, callbacks):
    ...
    if RANK in {-1, 0}:
        ...
        loggers = Loggers(save_dir=save_dir,weights=weights,opt=opt,hyp=hyp,logger=LOGGER,include=tuple(include_loggers))
